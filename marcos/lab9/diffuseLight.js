...
var matDif		= new Vector4();
	...
	console.log(matDif.elements[0] + " , " + matDif.elements[1] + " , " + matDif.elements[2]);
...
function webGLStart() {
	...
	canvas					= document.getElementById("difLight");
	canvas.onmousedown 		= handleMouseDown;
	gl 						= initGL(canvas);
	
	shader 					= initShaders("difLight", gl);	
	...
	if (shader.uLightPos < 0 	|| 
		shader.uLightColor < 0		|| shader.uMatDif < 0 ) {
		console.log("Error getAttribLocation"); 
		return;
		}
