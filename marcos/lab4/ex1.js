...
function drawScene(gl, shader) {
    ...
    gl.uniform1i(shader.flag, 1);
    gl.drawArrays(gl.TRIANGLES, 0, triangleVertexPositionBuffer.numItems);

    gl.viewport(gl.viewportWidth / 3, 0, gl.viewportWidth / 3, gl.viewportHeight / 3);
    gl.uniform1i(shader.flag, 2);
    gl.drawArrays(gl.TRIANGLES, 0, triangleVertexPositionBuffer.numItems);

    gl.viewport(2 * gl.viewportWidth / 3, 0, gl.viewportWidth / 3, gl.viewportHeight / 3);
    gl.uniform1i(shader.flag, 3);
    gl.drawArrays(gl.TRIANGLES, 0, triangleVertexPositionBuffer.numItems);
...
function initTexture(gl, shader) {
    ...
    image.onload = function() {
        ...
        canvas.height = image.height + image.width / 3;
        gl.viewportWidth = canvas.width;
        gl.viewportHeight = canvas.height - image.width / 3;
...
function webGLStart() {
    ...
    shader.flag = gl.getUniformLocation(shader, "flag");
