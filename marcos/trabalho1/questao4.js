...
// ********************************************************
function drawScene() {
	gl.viewport(0, gl.viewportWidth/2, gl.viewportWidth/2, gl.viewportHeight/2);
	...
	gl.viewport(gl.viewportHeight/2, gl.viewportWidth/2, gl.viewportWidth/2, gl.viewportHeight-(gl.viewportHeight/2));
	gl.uniform1i(shader.SamplerCor, 1);
	gl.drawArrays(gl.TRIANGLES, 0, vertPosBuf.numItems);
	
	gl.viewport(gl.viewportWidth/2, 0, gl.viewportWidth/2, gl.viewportHeight-(gl.viewportHeight/2));
	gl.uniform1i(shader.SamplerCor, 2);
	gl.drawArrays(gl.TRIANGLES, 0, vertPosBuf.numItems);
	
	gl.viewport(0, 0, gl.viewportWidth/2, gl.viewportHeight-(gl.viewportHeight/2));
